...
if (Config.WORKTYPE == 'private') {
    ...
    Asena.addCommand({pattern: 'media$', fromMe: true, desc: Lang.XMEDİA_DESC}, (async (message, match) => {    
    ...
    Asena.addCommand({pattern: 'bwimage', fromMe: true, dontAddCommandList: true}, (async (message, match) => {    
        ...
        ffmpeg(location)
            ...
            .save('output.png')
            .on('end', async () => {
                await message.sendMessage(fs.readFileSync('output.png'), MessageType.image, {mimetype: Mimetype.png, caption: 'Made by WhatsAsena'});
        });
        return await message.client.deleteMessage(message.jid, {id: downloading.key.id, remoteJid: message.jid, fromMe: true})
    }));
