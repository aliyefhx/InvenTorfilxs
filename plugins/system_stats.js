...
if (Config.WORKTYPE == 'private') {
    ...
    Asena.addCommand({pattern: 'aliyefh', fromMe: true, desc: Lang.ALIVE_DESC}, (async (message, match) => {

        if (Config.ALIVEMSG == 'default') {
            await message.client.sendMessage(message.jid,'```Bot Çalışıyor```\n\n*Version:* ```'+Config.VERSION+'```\n*Branch:* ```'+Config.BRANCH+'```\n*Telegram :* https://t.me/aliyefh_sos\n*\n*Plugin Channel:* ' + Config.CHANNEL , MessageType.text);
        }
        else {
    ...
    Asena.addCommand({pattern: 'aliyefh', fromMe: false, desc: Lang.ALIVE_DESC}, (async (message, match) => {
